...
(function (GeoJsonCustomShaderExample) {
    const getGeoBox = () => {
        ...
        const geoBox = new harp_geoutils_1.GeoBox(harp_geoutils_1.GeoCoordinates.fromGeoPoint(ring[0]), harp_geoutils_1.GeoCoordinates.fromGeoPoint(ring[0]));
        ring.forEach(geoPoint => geoBox.growToContain(harp_geoutils_1.GeoCoordinates.fromGeoPoint(geoPoint)));
        return geoBox;
    };
    ...
    class CustomShaderApp {
        constructor(container) {
            const canvas = typeof container === "string"
                ...
                : container;
            this.mapView = new harp_mapview_1.MapView({
                canvas,
            ...
            const mapControls = new harp_map_controls_1.MapControls(this.mapView);
        ...
        addEvRange() {
            const datasource = new harp_vectortile_datasource_1.VectorTileDataSource({
                dataProvider: new harp_vectortile_datasource_1.GeoJsonDataProvider("geojson", geojson),
    ...
    main();
})(GeoJsonCustomShaderExample = exports.GeoJsonCustomShaderExample || (exports.GeoJsonCustomShaderExample = {}));
...
/******/ 		var installedChunks = {
/******/ 			"datasource_geojson_custom-shader": 0
/******/ 		};
/******/ 		
/******/ 		var deferredModules = [
/******/ 			["./src/datasource_geojson_custom-shader.ts","common"]
/******/ 		];
...
/******/ })()
;
//# sourceMappingURL=datasource_geojson_custom-shader_bundle.js.map