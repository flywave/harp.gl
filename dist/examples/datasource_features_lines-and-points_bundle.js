...
exports.hotspots = exports.faults = void 0;
/*
...
/***/ "./src/datasource_features_lines-and-points.ts":
/*!*****************************************************!*\
  !*** ./src/datasource_features_lines-and-points.ts ***!
  \*****************************************************/
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.LinesPointsFeaturesExample = void 0;
...
const geology_1 = __webpack_require__(/*! ../resources/geology */ "./resources/geology.ts");
/**
 ...
 */
var LinesPointsFeaturesExample;
(function (LinesPointsFeaturesExample) {
    ...
    const featuresDataSource = new harp_features_datasource_1.FeaturesDataSource({
        ...
        features: getFeatures(geology_1.faults)
    });
    ...
    function getFeatures(features) {
        ...
        for (const type of Object.keys(features)) {
            for (const featureName of Object.keys(features[type])) {
                ...
                const feature = new harp_features_datasource_1.MapViewLineFeature(features[type][featureName], { name, type });
                // end:harp_demo_features_linespoints_1.ts
                featuresList.push(feature);
            }
        }
        // snippet:harp_demo_features_linespoints_1.ts
        const hotspotsFeature = new harp_features_datasource_1.MapViewMultiPointFeature(geology_1.hotspots);
        // end:harp_demo_features_linespoints_1.ts
    ...
    function createBaseMap(theme) {
        ...
        const mapView = new harp_mapview_1.MapView({
            ...
            theme,
            target: new harp_geoutils_1.GeoCoordinates(10, -270),
            zoomLevel: 3.5,
            enableMixedLod: true
        });
...
})(LinesPointsFeaturesExample = exports.LinesPointsFeaturesExample || (exports.LinesPointsFeaturesExample = {}));
...
/******/ 		var installedChunks = {
/******/ 			"datasource_features_lines-and-points": 0
/******/ 		};
/******/ 		
/******/ 		var deferredModules = [
/******/ 			["./src/datasource_features_lines-and-points.ts","common"]
/******/ 		];
...
/******/ })()
;
//# sourceMappingURL=datasource_features_lines-and-points_bundle.js.map