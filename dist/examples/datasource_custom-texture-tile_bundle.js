...
/***/ "./src/datasource_custom-texture-tile.ts":
/*!***********************************************!*\
  !*** ./src/datasource_custom-texture-tile.ts ***!
  \***********************************************/
...
exports.CustomTextureTileDatasourceExample = void 0;
/*
 ...
 * ```
 */
var CustomTextureTileDatasourceExample;
(function (CustomTextureTileDatasourceExample) {
    ...
    CustomTextureTileDatasourceExample.initializeMapView = initializeMapView;
    const mapView = initializeMapView("mapCanvas");
    // snippet:harp_gl_datasource_webtile_1.ts
    function getTexture(tile) {
        return Promise.all([new harp_mapview_1.TextureLoader().load("resources/wests_textures/clover.png"), []]);
    }
...
})(CustomTextureTileDatasourceExample = exports.CustomTextureTileDatasourceExample || (exports.CustomTextureTileDatasourceExample = {}));
...
/******/ 		var installedChunks = {
/******/ 			"datasource_custom-texture-tile": 0
/******/ 		};
/******/ 		
/******/ 		var deferredModules = [
/******/ 			["./src/datasource_custom-texture-tile.ts","common"]
/******/ 		];
...
/******/ })()
;
//# sourceMappingURL=datasource_custom-texture-tile_bundle.js.map